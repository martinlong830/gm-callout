-- One-shot: paste in Supabase SQL editor if migration has not been applied.
-- Scopes public.employees to company_id (stops Red Poke roster bleed into other companies).
...
-- Optional: wipe any employees already tagged to company "test" (does not touch Red Poke).
-- delete from public.employees
-- where company_id in (
--   select id from public.companies where lower(trim(name)) = 'test'
-- );

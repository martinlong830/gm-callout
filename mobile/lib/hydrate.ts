...
export const EMPLOYEE_LIST_COLUMNS =
  'id, auth_user_id, company_id, first_name, last_name, display_name, phone, email, staff_type, employment_status, usual_restaurant, hourly_rate, clock_pin, meta';

export const EMPLOYEE_MANAGER_COLUMNS =
  'id, auth_user_id, company_id, first_name, last_name, display_name, phone, email, staff_type, employment_status, usual_restaurant, hourly_rate, clock_pin, meta, weekly_grid';
...
const EMPLOYEE_LIST_COLUMNS_NO_EMAIL =
  'id, auth_user_id, company_id, first_name, last_name, display_name, phone, staff_type, employment_status, usual_restaurant, hourly_rate, clock_pin, meta';

const EMPLOYEE_MANAGER_COLUMNS_NO_EMAIL =
  'id, auth_user_id, company_id, first_name, last_name, display_name, phone, staff_type, employment_status, usual_restaurant, hourly_rate, clock_pin, meta, weekly_grid';
